...
const METHODS: Record<string, { method: string; mime: string; ext: string }> = {
  pdf: {
    method: "olimp_construction.api.exports.ks2_pdf",
    mime: "application/pdf",
    ext: "pdf",
  },
  xlsx: {
    method: "olimp_construction.api.exports.ks2_excel",
...
export async function GET(request: Request) {
  ...
  return new NextResponse(buf, {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="KS-2_${name}.${spec.ext}"`,
